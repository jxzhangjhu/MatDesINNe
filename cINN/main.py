...
rng = 0
# # robotics_arm  xdim = 4; ydim=2
# data_x = pd.read_csv('Simulated_DataSets/Robotic_Arm/data_x.csv', header=None).values
# data_y = pd.read_csv('Simulated_DataSets/Robotic_Arm/data_y.csv', header=None).values

# ballistics, xdim = 4; ydim=1
# data_x = pd.read_csv('Simulated_DataSets/Ballistics/data_x.csv', header=None).values
# data_y = pd.read_csv('Simulated_DataSets/Ballistics/data_y.csv', header=None).values

# # crystals
# data_x = pd.read_csv('Simulated_DataSets/Crystals/feature6/data_x.csv', header=None).values
# data_y = pd.read_csv('Simulated_DataSets/Crystals/feature6/data_y.csv', header=None).values
# print(data_x)
# print(data_y)

# graph
# data0 = pd.read_csv('Simulated_DataSets/Graph/features_gen_10k.csv',header=None)
# data = data0.values
# data_x = data[:,0:6]
# data_y = data[:,6:31]

## sinewave problems toy example
# data_x = pd.read_csv('Simulated_DataSets/Sinusoidal_Wave/data_x_10k.csv', header=None).values
# data_y = pd.read_csv('Simulated_DataSets/Sinusoidal_Wave/data_y_10k.csv', header=None).values
...
def train_epoch():
    ...
    for epoch in range(c.n_epochs):
        ...
        # print('training losses', train_avg_loss)
        ...
        if epoch % c.eval_test == 0:
            ...
            for j, (x, y) in enumerate(test_loader):
                ...
                # yz_pad = c.add_pad_noise * torch.randn(c.batch_size, c.ndim_pad_zy).to(c.device)
                # # print('yz_pad',yz_pad)
                # z = torch.randn(c.batch_size, c.ndim_z).to(c.device)
                # Xpred = model.model(z, y, rev=True).cpu().data.numpy()
            ...
            # print('testing losses', test_avg_loss)
